...
function TrackOrderPageContent() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(
      "Your message has been sent to the shop. They will contact you shortly."
    );
  ...
  return (
    <div className="min-h-screen bg-white relative pb-20">
        ...
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              {order.category} | Qty :{" "}
              {order.quantity.toString().padStart(2, "0")} pcs
            </p>
                    ...
                    {!isLast && (
                      <div
                        className={`h-[90px] w-1 ${
                          item.completed && order.timeline[index + 1].completed
                            ? "bg-[#8B4513]"
                            : "bg-gray-200"
                        }`}
                      ></div>
      ...
      <div className="fixed bottom-[60px] left-0 right-0 p-4 bg-white shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] z-20">
        <button
          className="w-full bg-[#8B4513] text-white py-3 rounded-full"
            ...
            <div className="p-4">
              ...
              <div className="mb-6">
                <div className="flex justify-between mb-4">
                  ...
                  >
                    <svg
                      className="h-6 w-6 text-[#25D366] mb-2"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    >
