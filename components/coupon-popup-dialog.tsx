...
export default function CouponPopupDialog() {
  ...
  // Auto-close timer removed - popup only closes manually
    ...
    <DialogPrimitive.Root open={isOpen} onOpenChange={handleClose}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className={cn(
            "fixed left-[50%] top-[50%] z-50 w-full max-w-[95vw] md:max-w-[800px] translate-x-[-50%] translate-y-[-50%] p-0 duration-200",
