-- Run this SQL script in your Supabase SQL editor to create the delivery_charges table
...
CREATE INDEX IF NOT EXISTS idx_delivery_charges_type ON delivery_charges(type);
CREATE INDEX IF NOT EXISTS idx_delivery_charges_active ON delivery_charges(is_active);
CREATE INDEX IF NOT EXISTS idx_delivery_charges_distance ON delivery_charges(start_km, end_km)
WHERE type = 'distance';
